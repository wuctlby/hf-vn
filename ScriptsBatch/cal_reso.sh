...
export SCRIPT_PATH="/home/wuct/ALICE/reps/hf-vn/src/compute_reso.py"
...
function cal_reso() {
    ...
    local cmd="python3 $SCRIPT_PATH $AN_RES_FILE --centClass $cent_class --outputdir $OUTPUT_DIR --suffix $suffix"
    echo "Executing: $cmd"
    eval "$cmd"
}
export -f cal_reso
