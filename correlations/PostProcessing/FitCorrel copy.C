...
void FitCorrel(const TString cfgFileName = "config_CorrAnalysis.json")
{
  ...
  TFile* inFile = new TFile("/home/wuct/ALICE/reps/hf-vn-working/correlations/PostProcessing/Output_CorrelationExtraction_010_negDeta_Root/CorrelExtract_010_negDeta/CorrelationsResults/CorrelationsResults.root");
