...
void DhCorrelationFitter::SetFitFunction()
{
  ...
  switch (fTypeOfFitFunc) {
    ...
    case 8: // case 2 Gaus w periodicity + v2 modulation (delta) low mult
      ...
      fv1 = new TF1("fv1", "[1]* 2*[2]*TMath::Cos(x)", fMinCorr, fMaxCorr);
      fv2 = new TF1("fv2", "[1]* 2*[3]*TMath::Cos(2*x)", fMinCorr, fMaxCorr);
      fv3 = new TF1("fv3", "[1]* 2*[4]*TMath::Cos(3*x)", fMinCorr, fMaxCorr);
...
void DhCorrelationFitter::SetSingleTermsForDrawing(Bool_t draw)
{
  ...
  if (fTypeOfFitFunc == 3 || fTypeOfFitFunc == 6) {
    ...
    fv1->SetParameter(0, par[1]);
    fv1->SetParameter(1, par[2]);
    fv1->SetLineColor(6); // pink
    fv1->SetLineStyle(9);
    fv1->SetLineWidth(4);
